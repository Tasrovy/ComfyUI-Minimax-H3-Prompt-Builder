...
from .pipeline import (MiniMaxH3MultiSegmentGenerate, MiniMaxH3SecondPassResize, MiniMaxH3SecondPassUpscale,
    MiniMaxH3SegmentJoin, MiniMaxH3SegmentResultPrepare, MiniMaxH3SegmentSampler, MiniMaxH3SegmentTrim)
...
class MiniMaxH3PromptBuilderExtension(ComfyExtension):
    ...
    async def get_node_list(self):
        return [MiniMaxH3Character, MiniMaxH3ActorInstance, MiniMaxH3CharacterGroup, MiniMaxH3Language, MiniMaxH3Visual,
            ...
            MiniMaxH3SecondPassResize, MiniMaxH3SecondPassUpscale,
